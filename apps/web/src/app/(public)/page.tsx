  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="text-center">
            ...
            <div className="mt-10 sm:flex sm:justify-center">
              <div className="bg-white p-4 sm:p-6 rounded-lg shadow-xl w-full sm:w-auto">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        className="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border !text-gray-800"
                        style={{color: '#1f2937'}} // Adding inline style
                      />
                    </div>
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-extrabold text-blue-200 text-center mb-8">
          Browse by Category
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <div className="mt-4">
                <Link href="/search?category=imaging" className="text-sm font-medium text-blue-600 hover:text-blue-500">
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <div className="mt-4">
                <Link href="/search?category=preventive" className="text-sm font-medium text-blue-600 hover:text-blue-500">
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <div className="mt-4">
                <Link href="/search?category=lab" className="text-sm font-medium text-blue-600 hover:text-blue-500">
        ...
        <div className="text-center mt-8">
          <Link href="/search" className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-200">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6 text-center">
                <span className="flex items-center justify-center h-12 w-12 rounded-md bg-blue-600 text-white mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6 text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Compare</h3>
                <p className="mt-2 text-base text-gray-500">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6 text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Choose</h3>
                <p className="mt-2 text-base text-gray-500">
      ...
      <div className="bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:flex lg:items-center lg:justify-between">
          ...
          <div className="mt-8 flex justify-center lg:mt-0 lg:flex-shrink-0">
            <Link href="/register" className="inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50">
              Register Now
            </Link>
            <Link href="/about" className="ml-3 inline-flex items-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-800 hover:bg-blue-700">
              Learn more
            </Link>
          </div>
        </div>
